...
public class ServerLogDetails {
	...
	TreeMap<String, String> loadServerInfo() {
		...
		try {
			...
			// FileInputStream(this.getClass().getClassLoader().getResourceAsStream("serverlog_details.txt"));
			BufferedReader br = new BufferedReader(new InputStreamReader(
					this.getClass().getClassLoader().getResourceAsStream("serverlog_details.txt")));
	...
	void updateServerInfo(String env) {
		...
		TreeMap<String, String> hm = new TreeMap<String, String>();
		try {
			File file = new File("src/server_details.txt");
	...
	public static void main(String args[]) {
		new ServerLogDetails().loadServerInfo();
